...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_answer1.setOnClickListener(new OnClickListener() {
            @Override
        ...
        b_answer2.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                //check answer is correct
        ...
        b_answer3.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                //check answer is correct
        ...
        b_answer4.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                //check answer is correct

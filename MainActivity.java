 ...
 * MainActivity initialises variables and onCreate sets JSON onto screen to be shuffled.
 * Button logic sorts answers for counter variable.
 */
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //button 1
        b_answer1.setOnClickListener(v -> {
        ...
        //button 2
        b_answer2.setOnClickListener(v -> {
            //check answer is correct
        ...
        //button 3
        b_answer3.setOnClickListener(v -> {
            //check answer is correct
        ...
        //button 4
        b_answer4.setOnClickListener(v -> {
            //check answer is correct
    ...
    //makes list with all of the questions
    private void loadAllQuestions() {
        questionItems = new ArrayList<>();
        //loads questions into json string
        String jsonStr = loadJSONFromAsset("questions3.json");


        //loads all data into list
        try {
    ...
    private String loadJSONFromAsset(String file) {
        String json = "";
        try {
            InputStream is = getAssets().open("questions3.json");
